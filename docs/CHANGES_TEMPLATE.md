...
lost, and the reasoning is what a reviewer is reading this for.
...
**Anything I am unsure about:** what a reviewer should look at, or what you
...
- **A decision that could reasonably have gone the other way.** Renaming a
  ...
  reasoning, because a reviewer may disagree and has to know what was traded.
...
- **Anything you deleted.** Especially copy. Several sentences in this UI look
  redundant and are each a bug that reached a real user's screen -- see "Five
  things that look like clutter and are not" in
  [`FRONTEND_BRIEF.md`](FRONTEND_BRIEF.md). Removing one may be right; it
  should be a decision, not a tidy-up.
