...
def ln(i, name, qty, rate, total, conf="98"):
    """One line as the readers would return it. Short name because it appears
    in every attack below and a long one would bury the numbers."""
...
attack("A1 strip-as-unit, ratio 8.9x (under the 50x guard)",
       ...
       [ln(1, "Paracetamol 500mg Tablet", "1", "9.30", "9.30")], "9.30")
...
attack("A2 ratio engineered to 45x, just under the guard",
       ...
       [ln(1, "Paracetamol 500mg Tablet", "1", "41.85", "41.85")], "41.85")
...
attack("A3 digit substitution 1->7, single reader, high confidence",
       ...
       [ln(1, "Paracetamol 500mg Tablet", "10", "7.10", "71.00", conf="99")],
...
attack("A4 decimal shift 1.10 -> 11.00, single reader",
       ...
       [ln(1, "Paracetamol 500mg Tablet", "10", "11.00", "110.00", conf="99")],
...
attack("A5 pack-size crossing: 500ml bag vs 100ml ceiling",
       ...
       [ln(1, "Ringer Lactate Injection 500 ml", "1", "66.50", "66.50")], "66.50")
...
attack("A6 form_modifier collision via alias: ASPIRIN TAB",
       ...
       [ln(1, "ASPIRIN TAB 75 MG", "10", "0.43", "4.30")], "4.30")
...
attack("A7 GST-inclusive rate treated as ex-GST",
       ...
       [ln(1, "Paracetamol 500mg Tablet", "10", "1.04", "10.40")], "10.40")
...
attack("A8 bill-level discount vs compliant line",
       ...
       [ln(1, "Paracetamol 500mg Tablet", "10", "1.00", "10.00"),
        ln(2, "Augmentin 625 Duo Tablet", "10", "20.00", "200.00")], "150.00")
...
attack("A9 both interpretations over the red threshold",
       ...
       [ln(1, "Paracetamol 500mg Tablet", "2", "150.00", "300.00")], "300.00")
...
attack("A10 alias + release modifier: PANTOCID TAB vs SR row",
       ...
       [ln(1, "PANTOCID TAB", "15", "8.50", "127.50")], "127.50")
