...
// Left empty on purpose: this is a public repository and a deployment's
// contact address belongs to whoever deployed it, not to the code. Set it
// to your own address if you deploy this; the contact button and the
// footer link stay hidden while it is empty.
const CONTACT_EMAIL = ''
...
// handle and href are EMPTY on purpose. This is a public repository, so it
// ships no one's accounts; an entry with no href is not rendered. Fill in
// your own if you deploy this, or delete the entry.
const SOCIAL = [
